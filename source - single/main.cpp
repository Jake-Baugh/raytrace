...
HRESULT Init()
{
	...
	l_primitive.Circle.MidPosition			= D3DXVECTOR4 (0, 0, 700, 1);
	l_primitive.Circle.Radius				= 500;
	l_primitive.Circle.Color				= D3DXVECTOR3(1.0f, 0.0f, 0.0f);

	l_primitive.Triangle.Color				= D3DXVECTOR4(0.0f, 1.0f, 0.0f, 1.0f);
	l_primitive.Triangle.Position1			= D3DXVECTOR4(400.0f,-200.0f ,500.0f, 1.0f);
	l_primitive.Triangle.Position1			= D3DXVECTOR4(400.0f,400.0f ,800.0f, 1.0f);
	l_primitive.Triangle.Position1			= D3DXVECTOR4(400.0f,-200.0f ,1000.0f, 1.0f);
